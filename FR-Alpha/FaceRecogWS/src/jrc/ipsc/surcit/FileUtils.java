...
public class FileUtils
{
  ...
  private static final String TRAINING_DIR = "facerecog\\trainingImages";

  private static final String EF_CACHE = "eigen.cache";

  private static final String EIGENFACES_DIR = "facerecog\\eigenfaces";
  private static final String EIGENFACES_PREFIX = "eigen_";

  private static final String RECON_DIR = "facerecog\\reconstructed";
  private static final String RECON_PREFIX = "recon_";

  private static final String FILES_DIR = "facerecog\\files";
...
public static String getTrainingPath()
{
	...
	File dirF = new File(TRAINING_DIR);
	returnString = dirF.getAbsolutePath();
